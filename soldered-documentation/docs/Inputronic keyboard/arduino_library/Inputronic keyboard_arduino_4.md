---
slug: /inputronic-keyboard-new/arduino/oled-type
title: Inputronic Keyboard - Live typing to OLED
sidebar_label: Typing to OLED
id: inputronic-keyboard-new-arduino-4
hide_title: false
---
...
- Both devices connected via Qwiic (formerly easyC) or I²C
...
For e-paper displays like Inkplate, see the **InkplateType** example in the library.
