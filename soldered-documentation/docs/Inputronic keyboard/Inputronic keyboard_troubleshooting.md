---
slug: /inputronic-keyboard-new/troubleshooting
title: Inputronic Keyboard - Troubleshooting
sidebar_label: Troubleshooting
id: inputronic-keyboard-new-troubleshooting
hide_title: false
...
#### Check wiring
Ensure that your Qwiic (formerly easyC) cable is properly connected and in good condition. Try using the same cable with another Qwiic (formerly easyC)-compatible device to verify that it works. If the issue persists, swap it out for a different cable to rule out any possible damage or defects.
