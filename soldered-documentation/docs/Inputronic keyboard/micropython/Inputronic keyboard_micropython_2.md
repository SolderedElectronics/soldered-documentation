---
slug: /inputronic-keyboard-new/micropython/reading-keys
title: Inputronic Keyboard - Reading key events
sidebar_label: Reading key events
id: inputronic-keyboard-new-micropython-2
hide_title: false
---

## Connections for this example

Connect the Inputronic Keyboard to your microcontroller via Qwiic (formerly easyC) cable or I²C pins as shown in the Getting Started guide.
