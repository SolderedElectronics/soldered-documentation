...
```
<CenteredImage src="/img/bhi-385-smart-imu-breakout/accel-gyro-serial.png" alt="Serial monitor Accelerometer and gyroscope readings" caption="Serial monitor Accelerometer and gyroscope output" width="80%" />
