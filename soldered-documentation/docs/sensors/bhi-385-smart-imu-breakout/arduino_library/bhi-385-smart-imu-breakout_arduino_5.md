...
```
<CenteredImage src="/img/bhi-385-smart-imu-breakout/game-rotation-serial.png" alt="Serial monitor Game Rotation Vector readings" caption="Serial monitor Game Rotation Vector output" width="80%" />
