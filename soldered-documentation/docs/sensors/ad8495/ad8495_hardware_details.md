...
title: Thermocouple sensor AD8495 - Hardware details
...
| **VCC**     | Power    | Supply voltage (3V3 and 5V supportedF)                         |
| **OUT**     | Analog out     | Analog signal output pin (5 mV/°C)                        |
...
<WarningBox>The hardware repository for this board still needs to be updated! We're working on it. In case you need them, please [**contact us**](https://soldered.com/contact/) to recieve the latest hardware files fully corresponding to the product.</WarningBox>
