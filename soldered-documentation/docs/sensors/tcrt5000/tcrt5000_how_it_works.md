...
## Datasheet
For an in-depth look at technical specifications, refer to the official TCRT5000 and LM393 Datasheets:
...
The sensor works by transmitting infrared light from an LED and detecting the reflected light on its photoresistor. This alters the flow of current between its emitter and collector based on the intensity of the light it receives. 
