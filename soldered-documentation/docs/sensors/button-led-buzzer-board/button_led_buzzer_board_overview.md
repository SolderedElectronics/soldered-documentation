...
{/*
  ...
  - Product photo for the overview page
  - Store product link once the product is published (SKU 333182 confirmed from the board's own
    pinout diagram, but solde.red/333182 still 404s - not live yet)
*/}
