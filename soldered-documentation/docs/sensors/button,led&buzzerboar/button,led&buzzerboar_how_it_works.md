...
As a follower device, the onboard **ATTiny404** has a unique address that allows the host microcontroller to send commands and receive data, enabling control of the **LED**, **buzzer**, and reading of the **button** state.
