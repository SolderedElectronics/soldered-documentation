---
slug: /button,led&buzzerboar/overview
title: Button, LED & Buzzer Board - Overview
sidebar_label: Overview
id: button,led&buzzerboar-overview 
hide_title: false
...
{/* PLACEHOLDER: Replace url with the official product page URL once the product is live on soldered.com (e.g. https://solde.red/333182). Add image prop with the actual product image path once available.
<QuickLink 
  title="Button, LED & Buzzer Board" 
  description="333182"
  url="#"
  image="/img/button-led-buzzerboard/333182.jpg" 
/>
*/}
