...
Set an appropriate Output Data Rate (ODR) for the accelerometer and gyroscope.Low ODRs (e.g., 13Hz) are suitable for slow applicationswhile high ODRs (e.g., 104Hz or above) are better for real-time motion tracking.
...
#### Configure Full-Scale Range
 Set the full-scale range for accelerometer and gyroscope based on application requirements.**Accelerometer** ranges: ±2g, ±4g, ±8g, ±16g while **Gyroscope** ranges: ±125dps, ±250dps, ±500dps, ±1000dps, ±2000dps.
