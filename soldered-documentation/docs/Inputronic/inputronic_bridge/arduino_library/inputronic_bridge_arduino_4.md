...
<CenteredImage src="/img/inputronic_bridge/change_adress.png" alt="Serial Monitor output from the changeI2CAddress example" caption="Serial Monitor output after successfully changing the I2C address" width="900px" />
