---
slug: /inkplate/6flick/micropython/wifi/get-and-post-requests
title: Inkplate 6FLICK MicroPython - GET and POST requests
sidebar_label: GET and POST requests
id: get-and-post-requests
---

Inkplate 6FLICK can connect to the internet and make HTTP requests.
...
<CenteredImage src="/img/inkplate10-micropython/get-output.png" alt="Inkplate 6FLICK running the example code" caption="Example code output." width="1000px" />
...
if connect_wifi():
    # Data to send
    data = {"message": "Hello from Inkplate 6FLICK!"}
...
<CenteredImage src="/img/inkplate10-micropython/post-output.png" alt="Inkplate 6FLICK running the example code" caption="POST request message on webhook.site." width="800px" />
...
url="https://github.com/SolderedElectronics/Inkplate-micropython/blob/master/examples/inkplate6flick/get_request.py" />
...
url="https://github.com/SolderedElectronics/Inkplate-micropython/blob/master/examples/inkplate6flick/post_request.py" />
