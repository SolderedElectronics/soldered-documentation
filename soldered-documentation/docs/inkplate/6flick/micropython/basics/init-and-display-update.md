...
<InfoBox> To learn more about Grayscale mode, check [this documentation](/inkplate/6FLICK/micropython/basics/printing-text/#displaying-text-in-grayscale-and-more-text-parameters)</InfoBox>
