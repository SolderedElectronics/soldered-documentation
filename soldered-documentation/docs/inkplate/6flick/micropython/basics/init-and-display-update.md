---
slug: /inkplate/6flick/micropython/basics/init-and-display-update
title: Inkplate 6FLICK MicroPython - Initialization and display update
...
<InfoBox> To learn more about Grayscale mode, check [this documentation](/documentation/inkplate/6FLICK/micropython/basics/printing-text/#displaying-text-in-grayscale-and-more-text-parameters)</InfoBox>
