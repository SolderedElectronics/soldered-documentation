---
slug: /inkplate/6flick/micropython/microsd/formatting-the-microsd-card
title: Inkplate 6FLICK MicroPython - Formatting the microSD card
sidebar_label: Formatting the microSD card
id: formatting-the-microsd-card
---

The bulit-in microSD card slot on the back of Inkplate 6FLICK can be a great asset for your projects, either for storing a very large number of high-quality images which can be displayed or reading and writing data between deep sleep cycles.
...
<FunctionDocumentation
  ...
  parameters={[
    { type: 'Boolean', name: 'fast_boot', description: 'Optional. If True (default), use faster initialization to reduce startup time.' }
  ]}
/>
