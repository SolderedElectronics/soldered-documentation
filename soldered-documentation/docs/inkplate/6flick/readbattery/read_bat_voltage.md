...
<WarningBox>Connecting and using the battery correctly is important! Please refer to the <a href="/inkplate/6flick/hardware/battery">battery usage page</a> for guidance before use. </WarningBox> 
