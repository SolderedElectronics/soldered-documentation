...
This software is required to upload code to Inkplate 6MOTION. [**Download it from the official website**](https://www.st.com/en/development-tools/stm32cubeprog.html) and install it.

<WarningBox>Without STM32CubeProgrammer, uploading code to Inkplate 6MOTION will not be possible, and the Arduino IDE will return an error.</WarningBox>
...
<WarningBox>Arduino IDE 2.0 or newer is required for Inkplate 6MOTION.</WarningBox>
...
Click `Install` here:
<CenteredImage src="/img/inkplate_6_motion/motion_install_board.png" alt="Install Inkplate 6MOTION boards" caption="Adding Inkplate 6MOTION boards to Arduino IDE" width="400px" />
...
<CenteredImage src="/img/inkplate_6_motion/motion_install_lib.png" alt="Install Inkplate Motion library" caption="Installing the Inkplate Motion library" width="400px" />
...
<QuickLink 
  ...
  description="Detailed tutorial on how to upload code for Inkplate 6MOTION"
...
<QuickLink 
  ...
  description="Solve the most common issues with using Inkplate 6MOTION"
