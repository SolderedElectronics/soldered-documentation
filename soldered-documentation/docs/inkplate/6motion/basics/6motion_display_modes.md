...
<QuickLink 
  ...
  description="Full example using black and white display mode on Inkplate 6MOTION." 
...
<QuickLink 
  ...
  description="Full example using grayscale display mode on Inkplate 6MOTION." 
