...
<SectionTitle title="Setting up MicroPython" />
...
<CenteredImage src="/img/6color/vscode_upload_file.png" alt="Uploading the firmware binary from VS Code" caption="Upload .bin file to device" width="500px"/>
...
<CenteredImage src="/img/6color/thonny_cfg_install.png" alt="Thonny interpreter configuration" caption="Install or update Micropython" width="500px"/>
...
<CenteredImage src="/img/6color/thonny_cfg_install_select_img.png" alt="Selecting a local MicroPython image in Thonny" caption="Select Micropython image" width="500px"/>
...
```
  mpremote mip install github:SolderedElectronics/Inkplate-micropython/boards/inkplate6color
```
