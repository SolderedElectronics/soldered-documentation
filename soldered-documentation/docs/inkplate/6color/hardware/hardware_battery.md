...
Inkplate 6COLOR is compatible with **3.7V Li-ion batteries with protection**. If you purchased the **Inkplate 6COLOR enclosure and battery kit**, it includes a **[1200mAh 3.7V Li-ion battery](https://soldered.com/product/li-ion-battery-1200mah-3-7v/)** with a built-in protection circuit.  
...
On Inkplate 6COLOR the charge current is set by resistor **R14 (2.49 kΩ)** on the charger's `PROG` pin. The datasheet's equation is `I = 1000 / R_PROG(kΩ)` in mA, which works out to a charge current of roughly **400 mA**.
