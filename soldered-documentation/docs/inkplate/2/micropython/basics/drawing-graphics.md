---  
slug: /inkplate/2/micropython/basics/basic-bwr
title: Inkplate 2 – Basic Graphics
sidebar_label: Basic Graphics
id: graphics
hide_title: false  
---
...
<FunctionDocumentation
  ...
  parameters={[ 
    ...
    { type: 'bytearray', name: 'data', description: 'Bitmap bytearray' },
    { type: 'int', name: 'w', description: 'Width' },
    { type: 'int', name: 'h', description: 'Height' },
    { type: 'int', name: 'c', description: 'Color' }
  ]}
/>
