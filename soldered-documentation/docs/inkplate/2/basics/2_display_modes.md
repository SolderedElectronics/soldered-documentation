...
- Red pixels take the longest to refresh, so updates with red elements are a bit slower than pure black/white rendering.
- `INKPLATE2_WHITE` is the background color. Drawing with it erases content.
