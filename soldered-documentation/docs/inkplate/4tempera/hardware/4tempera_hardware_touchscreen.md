...
- No additional external touch hardware is required, as the controller is built in  
...
<InfoBox>Each display is sourced from previously deployed devices and thoroughly tested for touchscreen functionality during Inkplate 4TEMPERA production and quality control.</InfoBox>
