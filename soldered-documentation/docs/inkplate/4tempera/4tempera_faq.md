...
This page collects the most frequently asked questions and common issues encountered when using the **Inkplate 4TEMPERA**. Whether you're troubleshooting your first project or just getting familiar with the hardware, you'll find helpful guidance below.

<ExpandableSection title="I can't upload code to Inkplate 4TEMPERA">
...
Inkplate 4TEMPERA requires **Arduino IDE 2.0 or newer**. Make sure you're using the latest version for the best compatibility.
...
Start with an unmodified example sketch from the official Inkplate 4TEMPERA examples:

<QuickLink 
  title="Inkplate4TEMPERA_Black_White.ino" 
  description="Basic black-and-white display example for Inkplate 4TEMPERA." 
  url="https://github.com/SolderedElectronics/Inkplate-Arduino-library/blob/master/examples/Inkplate4TEMPERA/Basic/Inkplate4TEMPERA_Black_White/Inkplate4TEMPERA_Black_White.ino"
/>
...
Inkplate 4TEMPERA includes a capacitive touchscreen. If it's not working:

#### 1. Use your fingertip
The screen uses capacitive technology, so it won't respond to fingernails, gloves, or pressure-based input.
...
Inkplate 4TEMPERA features a frontlight for improved visibility in dark environments.
...
<ExpandableSection title="How do I connect a battery to Inkplate 4TEMPERA?">
Inkplate 4TEMPERA supports 3.7V Li-ion batteries via its **2-pin 2.0mm JST connector**. It includes onboard charging (MCP73831T) and switches over to battery power automatically when USB is disconnected.
...
<ExpandableSection title="Where can I find schematics and hardware files for Inkplate 4TEMPERA?">
All hardware files, including schematics, KiCad project files, and gerbers, are available in the [**Inkplate 4TEMPERA hardware GitHub repo**](https://github.com/SolderedElectronics/Soldered-Inkplate-4-TEMPERA-with-glass-panel-hardware-design).
...
3D printable enclosures and mounting models will be published in the [**Inkplate 4TEMPERA GitHub repository**](https://github.com/SolderedElectronics/Soldered-Inkplate-4-TEMPERA-with-glass-panel-hardware-design).
</ExpandableSection>

<ExpandableSection title="Can I use Inkplate 4TEMPERA as an external monitor?">
Not directly.

Inkplate is designed to run standalone Arduino sketches, not to act as a plug-and-play monitor. You can, however, write a sketch that accepts and displays data over USB, Wi-Fi, or Bluetooth.
</ExpandableSection>

<ExpandableSection title="Is Inkplate 4TEMPERA compatible with ESPHome or Home Assistant?">
Currently, there is **no official ESPHome support** for Inkplate 4TEMPERA.

We're working on expanding support across all Inkplate models, so ESPHome support may be added in the future.
</ExpandableSection>
