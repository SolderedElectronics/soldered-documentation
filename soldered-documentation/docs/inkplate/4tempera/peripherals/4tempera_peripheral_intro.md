...
<FunctionDocumentation functionName="inkplate.wakePeripheral()" description="Powers on a peripheral device on the Inkplate 4TEMPERA." returnDescription="None" parameters={[ { type: 'uint8_t', name: 'peripheral', description: "Peripheral constant (e.g., INKPLATE_TOUCH, INKPLATE_BME688, INKPLATE_APDS9960)." } ]} />
