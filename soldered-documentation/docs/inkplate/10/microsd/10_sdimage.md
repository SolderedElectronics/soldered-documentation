...
Let's draw the example images of different formats on Inkplate, download them from the [**Inkplate library**](https://github.com/SolderedElectronics/Inkplate-Arduino-library/tree/master/examples/Inkplate10/Advanced/microSD/Inkplate10_microSD_Pictures) and place them in the root folder of the microSD card:
