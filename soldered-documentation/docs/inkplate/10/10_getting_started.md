...
This software is required to upload code to Inkplate 10. [**Download it from the official website**](https://www.st.com/en/development-tools/stm32cubeprog.html) and install it.

<WarningBox>Without STM32CubeProgrammer, uploading code to Inkplate 10 will not be possible, and the Arduino IDE will return an error.</WarningBox>
...
## 3. Install Inkplate boards definition
