...
<InfoBox> To learn more about Grayscale mode, check [this documentation](/inkplate/10/micropython/basics/printing-text/#displaying-text-in-grayscale-and-more-text-parameters)</InfoBox>
