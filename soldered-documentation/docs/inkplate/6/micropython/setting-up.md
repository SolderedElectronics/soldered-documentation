...
To get started with MicroPython on your Inkplate 6, follow these next few steps. If you are new to MicroPython, check out our official **[MicroPython Guide](https://soldered.com/documentation/micropython/overview)** for a full setup and overview on how it works.
...
<CenteredImage src="/img/inkplate10-micropython/thonny_cfg_install.png" alt="Inkplate 6 Thonny" caption="Install or update Micropython" width="500px"/>
