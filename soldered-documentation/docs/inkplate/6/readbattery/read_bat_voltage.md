---  
slug: /inkplate/6/battery/read-voltage  
title: Inkplate 6 - Read Battery Voltage 
...
<WarningBox>Connecting and using the battery correctly is important! Please refer to the <a href="/inkplate/6/hardware/battery">battery usage page</a> for guidance before use. </WarningBox> 
...
<QuickLink 
  title="Inkplate6_Read_Battery_Voltage"
  description="GitHub link with all files" 
  url="https://github.com/SolderedElectronics/Inkplate-Arduino-library/tree/master/examples/Inkplate6/Advanced/Other/Inkplate6_Read_Battery_Voltage"
/>
