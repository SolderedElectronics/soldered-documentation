...
Inkplate 6's onboard **ESP32-WROVER** has some pins reserved for internal use (for example, the connection to the e-paper display) and cannot be used for end-user applications. This page contains a list of the available GPIO pins that can be used for external applications.
...
``GPIO EXPANDER 1: P1-3 to P1-7``, ``GPIO EXPANDER 2: P0-0 to P0-7, P1-0 to P1-7``

<InfoBox>On IO expander 1, pins P0-0 to P0-7 drive the e-paper power supply and panel control signals, P1-0 controls the GPIO0 MOSFET, P1-1 enables the battery voltage divider, and P1-2 switches microSD card power. Only P1-3 to P1-7 are free. IO expander 2 is entirely free and broken out to pads.</InfoBox>
...
| IO15         | microSD (CS), JP4 [**Check jumper details**](/inkplate/6/hardware/jumpers/#board-jumpers) | ADC2_CH3, TOUCH3, MTDO, HSPICS0, RTC_GPIO13, HS2_CMD, SD_CMD, EMAC_RXD3    |
...
| P1-3 to P1-7 **expander 1** | **FREE**         | I/O                                                                        |
| P0-0 to P0-7, P1-0 to P1-7 **expander 2** | **FREE**         | I/O                                                                        |