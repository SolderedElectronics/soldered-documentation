...
The **P82B715 I2C Bus Extender** breakout board is based on the **NXP/TI P82B715** chip — a bidirectional I²C bus buffer that extends the range and capacitance limits of standard I²C communication. By providing a **10× impedance transformation**, it reduces the effective bus capacitance seen by each side, allowing I²C signals to travel over cable runs of up to **30 metres** and drive capacitive loads of up to **3000 pF** — well beyond the standard 400 pF I²C limit.
...
- **Max cable length:** Up to **30 m** over standard cabling
