...
title: CAN Transceiver MCP2518 - Hardware details
id: mcp2518-hardware 
hide_title: false
...
<CenteredImage src="/img/mcp2518/pinout.png" alt="CAN Transceiver MCP2518 Breakout pinout diagram" caption="CAN Transceiver MCP2518 Breakout pinout diagram"/>

---

## Dimensions

- **Board Dimensions:** 38 × 22 mm (1.50 × 0.87 in)
...
<InfoBox>This board operates at 3.3 V logic internally but accepts VCC from 2.7 V to 5 V. Connect directly to both 3.3 V and 5 V microcontrollers without a level shifter.</InfoBox>
