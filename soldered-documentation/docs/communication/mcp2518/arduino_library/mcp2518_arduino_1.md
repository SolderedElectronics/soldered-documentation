---
slug: /mcp2518/arduino/getting-started 
title: CAN Transceiver MCP2518 - Getting started and Initialization
...
<FunctionDocumentation
  ...
  returnType="int"
  parameters={[
    { type: 'uint32_t', name: 'speedset', description: 'Bit rate constant, e.g. CAN_125KBPS for CAN 2.0B or CAN_125K_500K for CAN FD.' },
