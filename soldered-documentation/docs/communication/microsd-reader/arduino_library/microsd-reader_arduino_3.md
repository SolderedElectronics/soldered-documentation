...
If the module is the only SPI device connected to the bus, use dedicated SPI mode by **Setting the DISABLE_CS_PIN variable to -1**. That way transfers can be improved 10x in some cases.
