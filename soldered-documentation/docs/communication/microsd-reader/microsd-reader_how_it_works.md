...
The SD card reader communication is done by the **TXB0104** chip made by **Texas Instruments**
...
For an in-depth look at technical specifications, refer to the official TXB0104 Datasheet:  
...
The micro SD card's SPI interface is achieved through the standard 8-pin micro SD card pinout, and the pins are used in a way that corresponds to SPI signals. Here's how the micro SD card pinout relates to the SPI signals:
...
1. The host sends a write command along to the DI pin with data blocks
