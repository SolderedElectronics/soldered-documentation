...
<CenteredImage src="/img/txs0104/pinout.png" alt="Logic Level Converter pinout diagram" caption="Logic Level Converter I2C TSX0104 pinout diagram"/>
...
| **A1 - A4** | High Voltage Pins  | High-voltage side signal pins (typically 5V logic).       |
| **B1 - B4** | Low Voltage Pins   | Low-voltage side signal pins (typically 3.3V logic).      |
