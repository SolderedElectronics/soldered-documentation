...
**SSD1306** is a single-chip **CMOS OLED/PLED driver** with a controller for a organic/polymer light emitting
diode dot-matrix graphic display system. It consists of 128 segments and 64 commons. 

SSD1306 displays data directly from its internal 128 x 64 bits **Graphic Display Data RAM (GDDRAM)**.
Data/Commands are sent from general MCU through the hardware selectable **I2C Interface**.
