---
slug: /ssd1306-new/how-it-works
title: SSD1306 – How it works
sidebar_label: How it works
id: ssd1306-new-how-it-works
hide_title: false
---
...
The SSD1306 uses the I2C protocol to communicate with a microcontroller. It operates with an I2C address of **0x3C** (it can also operate with an address of **0x3D** when shorting the **JP6** jumper—see the jumper details [**here**](/ssd1306-new/hardware#jumper-details)).
