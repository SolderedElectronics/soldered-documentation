...
<QuickLink
title="NULA Mini ESP32-C6"
description="Compact RISC-V Wi-Fi 6 development board with Bluetooth 5.3, Zigbee, and Thread connectivity."
...
* **Wi-Fi 6 Connectivity:** Integrated 802.11ax (2.4 GHz) for efficient, low-latency IoT networking  
* **Bluetooth 5.3 LE:** Supports mesh networking, long-range, and high-speed data transfer  
* **Thread/Zigbee Ready:** IEEE 802.15.4 radio for Matter-compatible smart home applications  
...
<QuickLink 
  ...
  description="Rechargeable 3.7 V Li-Ion battery compatible with NULA Mini’s JST connector."
