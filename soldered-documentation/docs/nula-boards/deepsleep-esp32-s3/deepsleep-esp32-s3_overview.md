---
slug: /deepsleep-esp32-s3/overview
title: NULA DeepSleep ESP32 S3 - Overview
sidebar_label: Overview
id: deepsleep-esp32-s3_overview
...
* **Dual-Core Processor:** Xtensa® LX7 CPU running up to 240 MHz  
* **Wireless Connectivity:** Integrated 2.4 GHz Wi-Fi and Bluetooth 5 (LE)  
* **Ultra-Low Power Design:** Deep-sleep consumption below 10 µA  
* **Battery Ready:** Onboard Li-Ion charging circuit and JST connector  
...
<QuickLink 
  title="Qwiic cable" 
  description="Qwiic (formerly easyC) compatible cables for quick sensor connections."
