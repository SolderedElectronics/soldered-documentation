...
- Iz **reda 11**, gdje sjedi kratka nožica LED-ice, do plave **−** tračnice.
- Iz **j30** (`GND`) do te iste tračnice.

<CenteredImage src="/img/nula-beginner-kit-arduino/3_2_step5_ground.webp" alt="Dvije crne jumper žice, jedna iz reda 11 i jedna iz j30, obje idu na negativnu tračnicu" caption="Korak 5: LED-ica i GND pin pločice oboje vezani na plavu − tračnicu" width="650px"/>
...
Cijeli put je sada **IO2 → 330 Ω → LED-ica → − tračnica → GND**. To je isti lanac kao u [**1.2 Blinkanje LED-ice**](/soldered-nula-beginner-kit-arduino-hrv/led-blinking), izgrađen na drugom pinu. Razlika je u potpunosti u kodu: umjesto da pin uključujemo i isključujemo, držat ćemo ga negdje između.
