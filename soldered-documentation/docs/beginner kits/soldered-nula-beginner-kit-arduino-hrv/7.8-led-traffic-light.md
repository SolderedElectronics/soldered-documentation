...
Kratka plava jumper žica vodi **`j30`** (pin **GND** pločice) dolje do plave `−` tračnice. Sve u ovom krugu vraćat će se do mase preko te tračnice.

<InfoBox>Stavi oba kraja svake žice tračnice u stupac rupica koji ide **točno uz plavu liniju**. Pojas tračnice ima dva stupca rupica i to nije isto spojište.</InfoBox>

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step01_gnd_rail.webp" alt="Plava jumper žica spaja GND pin pločice na plavu tračnicu mase" caption="Plava: j30 (GND) na plavu − tračnicu" width="650px"/>
...
Plava jumper žica vodi **`j17`** dolje do plave `−` tračnice, čime je prvi lanac dovršen.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step05_green_ground.webp" alt="Plava jumper žica spaja red 17 na tračnicu mase" caption="Plava: j17 na plavu − tračnicu" width="650px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step09_orange_ground.webp" alt="Plava jumper žica spaja red 11 na tračnicu mase" caption="Plava: j11 na plavu − tračnicu" width="650px"/>
...
Posljednja plava jumper žica vodi **`j5`** dolje do plave `−` tračnice. Krug je sada dovršen.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step13_red_ground.webp" alt="Posljednja plava jumper žica spaja red 5 na tračnicu mase" caption="Plava: j5 na plavu − tračnicu" width="650px"/>
...
| # | Dio | Iz | U | Što radi |
| --- | --- | --- | --- | --- |
| 1 | Jumper žica | `j30` (**GND**) | plava `−` tračnica | Čini tračnicu dijeljenom masom |
...
| 5 | Jumper žica | `j17` | plava `−` tračnica | Zelena LED-ica natrag na masu |
...
| 9 | Jumper žica | `j11` | plava `−` tračnica | Narančasta LED-ica natrag na masu |
...
| 13 | Jumper žica | `j5` | plava `−` tračnica | Crvena LED-ica natrag na masu |
