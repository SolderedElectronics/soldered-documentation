...
Masa ide u dva skoka, koristeći plavu **−** tračnicu duž ruba breadboarda kao dijeljenu liniju mase.

- Prva jumper žica: iz reda u kojem je **GND** (red 30 na fotografiji) do plave **−** tračnice.
- Druga jumper žica: s te iste plave **−** tračnice natrag u **red 15**, na **f–j** strani tipke.

<CenteredImage src="/img/nula-beginner-kit-arduino/2_1_step3_ground.webp" alt="Dvije jumper žice spajaju GND na tipku preko negativne tračnice" caption="Korak 3: GND dolazi do tipke preko plave − tračnice" width="650px"/>

<InfoBox>Obje žice moraju ići u **isti** stupac tračnice, onaj koji ide uz plavu liniju. Tračnica uz crvenu liniju je zaseban pojas i nije spojena s njom.</InfoBox>
...
Jedna jumper žica zatvara krug: iz **reda 3**, gdje sjedi kratka nožica LED-ice, do plave **−** tračnice, iste tračnice koju tipka već koristi za masu.

<CenteredImage src="/img/nula-beginner-kit-arduino/2_2_step3_ground.webp" alt="Jumper žica spaja katodu LED-ice na negativnu tračnicu" caption="Korak 7: kratka nožica LED-ice spojena na plavu − tračnicu" width="650px"/>

Cijeli put je sada **IO4 → 330 Ω → LED-ica → − tračnica → GND**. Budući da je tračnica dijeljena, tipka i LED-ica masu uzimaju s istog mjesta.
