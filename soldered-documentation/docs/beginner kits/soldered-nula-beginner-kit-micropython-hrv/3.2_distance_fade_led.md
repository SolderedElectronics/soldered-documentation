...
Cijeli put je sada **IO2 → 330 Ω → LED-ica → − tračnica → GND**. To je isti lanac kao u [**1.2 Blinkanje LED-ice**](/soldered-nula-beginner-kit-micropython-hrv/led-blinking), izgrađen na drugom pinu. Razlika je u potpunosti u kodu: umjesto da pin uključujemo i isključujemo, držat ćemo ga negdje između.
