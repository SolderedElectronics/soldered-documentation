...
### 2. Sagradi tračnicu mase

Kratka plava jumper žica vodi **`j30`** (**GND** pin pločice) dolje do plave `−` tračnice. Sve u ovom krugu put natrag do mase naći će preko te tračnice.

<InfoBox>Stavi oba kraja svake žice tračnice u stupac rupica koji ide **neposredno uz plavu liniju**. Pojas tračnice ima dva stupca rupica i to nije isti spoj.</InfoBox>

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step01_gnd_rail.webp" alt="Plava jumper žica spaja GND pin pločice na plavu tračnicu mase" caption="Plava: j30 (GND) do plave − tračnice" width="650px"/>
...
Plava jumper žica vodi **`j17`** dolje do plave `−` tračnice, čime se prvi lanac dovršava.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step05_green_ground.webp" alt="Plava jumper žica spaja red 17 na tračnicu mase" caption="Plava: j17 do plave − tračnice" width="650px"/>
...
Plava jumper žica vodi **`j11`** dolje do plave `−` tračnice.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step09_orange_ground.webp" alt="Plava jumper žica spaja red 11 na tračnicu mase" caption="Plava: j11 do plave − tračnice" width="650px"/>
...
Posljednja plava jumper žica vodi **`j5`** dolje do plave `−` tračnice. Krug je sada potpun.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_8_step13_red_ground.webp" alt="Posljednja plava jumper žica spaja red 5 na tračnicu mase" caption="Plava: j5 do plave − tračnice" width="650px"/>
...
| Dio | Spoj | Što radi |
| --- | --- | --- |
| Jumper žica | `j30` (**GND**) → plava `−` tračnica | Čini tračnicu dijeljenom masom |
...
| Jumper žica | `j17` → plava `−` tračnica | Zelena LED-ica natrag na masu |
...
| Jumper žica | `j11` → plava `−` tračnica | Narančasta LED-ica natrag na masu |
...
| Jumper žica | `j5` → plava `−` tračnica | Crvena LED-ica natrag na masu |
