...
### 2. Izvedi masu na tračnicu

Jedna jumper žica iz **j30** (`GND`) do plave **−** tračnice. Ta tračnica postaje dijeljena masa cijelog kruga, i obje se polovice vraćaju na nju.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_4_step2_gnd_rail.webp" alt="Jumper žica iz j30 na plavu negativnu tračnicu" caption="Korak 2: GND izveden na plavu − tračnicu" width="650px"/>
...
Jedna jumper žica iz **reda 9** do plave **−** tračnice.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_4_step6_resistor_ground.webp" alt="Jumper žica spaja red 9 na negativnu tračnicu" caption="Korak 6: donji kraj otpornika od 10 kΩ spojen na − tračnicu" width="650px"/>
...
Jedna jumper žica iz **reda 3** do plave **−** tračnice. Sva tri kanala boje vraćaju se na masu preko te jedne žice.

<CenteredImage src="/img/nula-beginner-kit-arduino/7_4_step9_cathode.webp" alt="Jumper žica spaja red zajedničke katode na negativnu tračnicu" caption="Korak 9: zajednička katoda spojena na plavu − tračnicu" width="650px"/>
...
1. **Provjeri je li duga nožica u redu 3** i spojena na **−** tračnicu. Ako je dijeljena nožica negdje drugdje, kanali se međusobno bore i većinom ostaju tamni.
