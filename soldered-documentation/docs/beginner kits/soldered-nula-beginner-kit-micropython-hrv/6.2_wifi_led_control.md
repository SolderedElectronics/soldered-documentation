...
Krug je sada jedan neprekinut lanac: `IO4` → red 19 → otpornik → red 14 → LED-ica → red 12 → **−** tračnica → `GND`. Struja može teći samo kada skripta dovede `IO4` u visoko stanje, a to je točno ono što će tipka ON napraviti.
