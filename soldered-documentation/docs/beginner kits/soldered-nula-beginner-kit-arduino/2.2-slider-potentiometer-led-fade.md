...
<CenteredImage src="/img/nula-beginner-kit-arduino/2_2components.jpg" alt="All components" caption="All components needed for this example" />
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_2_1.jpg" alt="USB connection" caption="Connecting the NULA MINI board to PC via USB-c cable." />
...
Take a piece of jumper wire and connect one end to an available GPIO pin on the board. For this example, we will be using **IO4** pin. Connect the other end to any free power rail on the breadboard.

<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_2_2.jpg" alt="Step 1." caption="Step: 1." />
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_2_3.jpg" alt="Step 2." caption="Step: 2." />
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_2_4.jpg" alt="Step 3." caption="Step: 3." />
---
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_2_5.jpg" alt="Step 4." caption="Step: 4." />

Connect the Slider pins to NULA MINI board as per the table below:

| **Slider potentiometer** 	| **NULA MINI** 	|
|---	|---	|
| VCCA 	| 3.3V 	|
| GND 	| GND 	|
| OUTA 	| IO3 (or any ADC pin) 	|

<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_2_6.jpg" alt="Step 5." caption="Step: 5." />

---

## Reading analog values
The **Soldered NULA MINI** board has a 12-bit multi-channel ADC (analog-to-digital converter) that reads analog signals and converts it into integer values between 0 and 4095. This process is called **sampling**.
...
To read the potentiometer's value, we call `analogRead(pin)` function. Since the ADC resolution of the NULA MINI is **12-bits**, the function returns a value between 0 and 4095. We call the function inside the **loop()**:

<InfoBox>It is recomended to call the **analogReadResolution(12)** in the **setup()** because the default value is usually 10 or 8!</InfoBox>
...
In this example we will be using the pin 3.
*/
int POT_PIN = 3;
...
The function `analogWrite(pin, value)` controls the duty cycle. By default, **value** expects 0-255 (8-bit resolution). But since the NULA RP2040 supports **12-bit PWM**, we can set the resolution to match the ADC and work directly with values from 0-4095 by caling `analogWriteResolution(pin, bits)` in setup:
