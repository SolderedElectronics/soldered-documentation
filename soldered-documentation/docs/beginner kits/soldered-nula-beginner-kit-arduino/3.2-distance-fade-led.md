...
### 1. Connect the LED
We will start by connecting the LED the same way as in [**1.1 LED Blinking**](/soldered-nula-beginner-kit-arduino/led-blinking).  
...
<CenteredImage src="/img/nula-beginner-kit-arduino/pwm-explained.png" alt="PWM explained" caption="PWM visualization" width="1800px"/>
