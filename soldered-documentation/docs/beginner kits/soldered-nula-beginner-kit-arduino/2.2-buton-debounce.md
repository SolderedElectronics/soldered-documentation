...
<ReactPlayer src='../../videos/nula-mini-beginner-kit-arduino/C0015.mp4' width='100%' height='auto' muted='true' autoPlay='true' loop='true' caption="Full example video"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00195.JPG" alt="USB connection" caption="Connecting the NULA MINI board to PC via USB-c cable." windth="1800px"/>
...
Using a jumper wire, connect **IO19** on the NULA MINI to one leg of the push button on the breadboard. Connect the opposite leg of the button to GND through a 10kΩ resistor, and also connect that same leg to 3.3V. Your completed circuit should look like this:

<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00209.JPG" alt="Step: 1." caption="Step: 1." windth="1800px"/>
...
### 3. Connect the LED to the NULA MINI board
Connect **IO4** on the NULA MINI to one leg of a 330Ω resistor on the breadboard. Attach the LED’s anode (long leg) to the other side of the resistor, and connect the cathode (short leg) directly to GND on the board.
Your completed circuit should look like this:

<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00210.JPG" alt="Step: 1." caption="Step: 1." windth="1800px"/>
---
