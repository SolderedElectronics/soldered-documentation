...
The goal of this example is to teach you how to control an LED with the **Soldered NULA MINI** board. This is usually the very first project when learning microcontrollers because it introduces you to the most fundemental concept: making a pin go HIGH (on) or LOW (off). 
...
<InfoBox>For this step you need to be familiar with the internal structure of a breadboard and its power rails. To familiarize, check out [**Breadboard Fundementals**](/documentation/soldered-nula-beginner-kit-arduino/breadboard-fundementals/#what-is-a-breadboard) documentation page.</InfoBox>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00195.JPG" alt="NULA MINI on breadboard" caption="NULA MINI on breadboard" width="1800px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00196.JPG" alt="Step 2 of connections" caption="Step: 2" width="1800px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00197.JPG" alt="Step 3 of connections" caption="Step: 3" width="1800px"/>

Take the LED and inspect its pins, there should be one longer than the other like this:

<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00198.JPG" alt="Step 4 of connections" caption="Step: 4" width="1800px"/>

Connect the longer one (Anode) to the power rail that is connected to the other end of the 330 ohm resistor.

<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00199.JPG" alt="Step 5 of connections" caption="Step: 5" width="1800px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00204.JPG" alt="USB connection" caption="Connecting the NULA MINI board to PC via USB-c cable." width="1800px"/>
---
...
You can basically use any IO marked pin on the board, below is the picture with all GPIO pins that you can use on the NULA board:
