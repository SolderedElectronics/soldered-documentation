...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection1.jpg" alt="NULA MINI on breadboard" caption="NULA MINI on breadboard" width="600px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection2.jpg" alt="Step 2 of connections" caption="Step: 2" width="600px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection3.jpg" alt="Step 3 of connections" caption="Step: 3" width="600px"/>

Take the LED and inspect its pins, there should be one longer than the other like this:

<CenteredImage src="/img/nula-beginner-kit-arduino/connection4.jpg" alt="Step 4 of connections" caption="Step: 4" width="600px"/>

Connect the longer one (Anode) to the power rail that is connected to the other end of the 330 ohm resistor.

<CenteredImage src="/img/nula-beginner-kit-arduino/connection5.jpg" alt="Step 5 of connections" caption="Step: 5" width="600px"/>
...
<CenteredImage src="/img/nula-beginner-kit-arduino/connection2_1.jpg" alt="USB connection" caption="Connecting the NULA MINI board to PC via USB-c cable." width="600px"/>
---
...
<CenteredImage src="/img/under_construction.png" alt="placeholder" caption="All available IO pins on NULA MINI" width="600px"/>
