...
<ReactPlayer src='../../videos/nula-mini-beginner-kit-arduino/C0019.mp4' width='100%' height='auto' muted='true' autoPlay='true' loop='true' caption="Full example video"/>
...
onnect **IO4** on the NULA MINI to one leg of a 330Ω resistor on the breadboard. Attach the LED’s anode (long leg) to the other side of the resistor, and connect the cathode (short leg) directly to GND on the board.
Your completed circuit should look like this:

<CenteredImage src="/img/nula-beginner-kit-arduino/DSC00223.JPG" alt="Step: 1." caption="LED wiring" windth="1800px"/>
